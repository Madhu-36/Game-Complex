    ...
    <div className="min-h-screen w-full flex items-center justify-start font-sans">
      ...
      <div className="w-full lg:w-1/3 min-h-screen p-8 lg:p-12 xl:p-24 flex flex-col justify-center bg-transparent relative z-10">
        <div className="w-full max-w-sm mx-auto">
          <div className="mb-10">
            <h2 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-400 tracking-tighter mb-2 drop-shadow-md">Join Us</h2>
            <p className="text-gray-100 font-bold drop-shadow-sm">Create your account to start gaming</p>
          </div>
          ...
          <div className="mt-8 text-center text-sm text-gray-300">
            ...
            <Link to="/login" className="text-green-400 hover:text-green-300 font-bold transition-colors drop-shadow-sm">
              Sign in
            </Link>
          </div>
        </div>
